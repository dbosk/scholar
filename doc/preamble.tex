...
% LaTeX Error: Unicode character  (U+0080) not set up for use with LaTeX.
\newunicodechar{}{\texttt{[0x80]}}
% LaTeX Error: Unicode character  (U+0093) not set up for use with LaTeX.
\newunicodechar{}{\texttt{[0x93]}}
